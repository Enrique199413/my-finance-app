            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <button 
                        onClick={loadData} 
                        disabled={refreshing}
                        className="p-2 rounded-xl bg-gray-100 dark:bg-primary-800 text-black/80 dark:text-white/80 hover:bg-gray-200 dark:hover:bg-primary-700 transition-colors disabled:opacity-50 mt-1"
                                ...
                                <div className="flex items-start justify-between mb-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-black/70 dark:text-white/70">{account.bank} · {t(`accounts.${account.type}`)}</p>
                                        </div>
                                    </div>
                                    {isOwner && (
